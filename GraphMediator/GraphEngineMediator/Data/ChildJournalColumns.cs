...
namespace GraphMediator.GraphEngineMediator
{
    internal static class ChildJournalColumns
    {
        ...
        internal static readonly Column HeadCircumference = new Column(
            nameof(HeadCircumference),
            (column, value) => throw new ArgumentException("Not a valid column to search"),
            Double);

        internal static readonly Column BMI = new Column(
            nameof(BMI),
            (column, value) => throw new ArgumentException("Not a valid column to search"),
            Double);
        ...
        internal static readonly Column ExaminationDate = new Column(
