...
namespace Engine.Quantities {
    ...
    public class Unit {
        ...
        internal static readonly Unit GasMark = new(125 / 9.0, -218.0 / 25, Celsius);
        internal static readonly Unit Kelvin = new(1, 273.15, Celsius);
        internal static readonly Unit Rankin = new(5 / 9.0, 491.67, Celsius);
